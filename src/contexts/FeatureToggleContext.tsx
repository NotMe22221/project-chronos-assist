...
const VOICE_COMMANDS: Array<{
  ...
  {
    patterns: [/stop\s+talk/i, /be\s+quiet/i, /shut\s+up/i, /mute\s+(voice|yourself)/i, /disable\s+voice/i, /stop\s+speaking/i],
    feature: 'voiceResponses',
    action: false,
    response: 'Voice responses disabled.',
  },
  {
    patterns: [/start\s+talk/i, /unmute/i, /enable\s+voice/i, /resume\s+(talk|speak|voice)/i],
    feature: 'voiceResponses',
    action: true,
    response: 'Voice responses enabled.',
  },
  {
    patterns: [/stop\s+hand/i, /disable\s+hand/i, /stop\s+gesture/i, /disable\s+gesture/i, /turn\s+off\s+(hand|gesture)/i],
    feature: 'handTracking',
    action: false,
    response: 'Hand gesture control disabled.',
  },
  {
    patterns: [/start\s+hand/i, /enable\s+hand/i, /start\s+gesture/i, /enable\s+gesture/i, /turn\s+on\s+(hand|gesture)/i],
    feature: 'handTracking',
    action: true,
